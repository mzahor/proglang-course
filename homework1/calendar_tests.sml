...
val check124 = number_in_months_challenge(ds, ms1 @ ms1) = number_in_months(ds,
ms1);
val check125 = number_in_months_challenge(ds, ms2 @ ms2) = number_in_months(ds,
ms2);
val check126 = number_in_months_challenge(ds, ms3 @ ms3) = number_in_months(ds,
ms3);
...
val check12B = dates_in_months_challenge(ds, ms1 @ ms1)=dates_in_months(ds,
ms1);
val check12C = dates_in_months_challenge(ds, ms2 @ ms2)=dates_in_months(ds,
ms2);
val check12D = dates_in_months_challenge(ds, ms3 @ ms3)=dates_in_months(ds,
ms3);
val check12E = dates_in_months_challenge(ds, ms4 @ ms4)=dates_in_months(ds,
ms4);
