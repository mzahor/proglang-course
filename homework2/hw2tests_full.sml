...
val test31 = get_substitutions2 (names1, "Fred")  = ["Freddie", "F", "Fredrick"]
val test32 = get_substitutions2 (names2, "Jeff") = ["Geoff", "Jeffrey", "Jeffrey"]
...
val test43 = similar_names (names1, {first = "Jeff", middle = "W", last = "Smith"}) =
...
val testD3 = all_same_color cards3 = false
val testD4 = all_same_color [(Clubs, Jack), (Spades, Num 8), (Hearts, King)] = false
val testD5 = all_same_color [(Clubs, Jack), (Hearts, King), (Spades, Num 8)] = false
val testD6 = all_same_color [(Hearts, King), (Clubs, Jack), (Spades, Num 8)] = false
(*
